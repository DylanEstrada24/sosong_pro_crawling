...
router.get('/v1/test4_3', (req, res) => {
    res.send('<html lang="ko">\n' +
        ...
        '                                        <option value="3" selected="selected">제출서류</option>\n' +
        '                                        <option value="4">송 달</option>\n' +
        '                                    </select>\n' +
        '                                    <a className="fr blueBtn" href="#"\n' +
        '                                       ><a href="http://localhost:8883/api/v1/test4_4">선택</a>\n' +
        '                                </div>\n' +
        '                            </div>\n' +
        '\n' +
        '                            <!-- tableHor-->\n' +
        ...
        '                                    <td className="tit" style="color: #660000;">&nbsp;피고 김진식 답변서 제출</td>\n' +
        '                                    <td style="color: #660000;">&nbsp; </td>\n' +
        '                                </tr>\n' +
        '\n' +
        '                                <tr>\n' +
        '                                    <td style="color: #660000;">&nbsp;2021.08.11</td>\n' +
        '                                    <td className="tit" style="color: #660000;">&nbsp;원고 소송대리인 강청현 소송대리인 사임서 제출</td>\n' +
        '                                    <td style="color: #660000;">&nbsp; </td>\n' +
        '                                </tr>\n' +
        '\n' +
        '                                <tr>\n' +
        '                                    <td style="color: #660000;">&nbsp;2021.08.11</td>\n' +
        '                                    <td className="tit" style="color: #660000;">&nbsp;원고 소송대리인 강청현 소송위임장 제출</td>\n' +
        '                                    <td style="color: #660000;">&nbsp; </td>\n' +
        '                                </tr>\n' +
        '\n' +
        '                                </tbody>\n' +
