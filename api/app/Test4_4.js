...
router.get('/v1/test4_4', (req, res) => {
    res.send('<html lang="ko">\n' +
        ...
        '                                        <option value="4" selected="selected">송 달</option>\n' +
        '                                    </select>\n' +
        '                                    <a className="fr blueBtn" href="#"\n' +
        '                                       onClick="javascript:goMove(document.getElementsByName(\'select\')[0].options[document.getElementsByName(\'select\')[0].selectedIndex].value);">선택</a>\n' +
        '                                </div>\n' +
        '                            </div>\n' +
        '\n' +
        '                            <div className="infoBox">\n' +
        ...
        '                                </div>\n' +
        '                                <div className="mt10">\n' +
        '                                    <label htmlFor="songdalchk">결과저장</label>\n' +
        '                                    <input name="songdalchk" type="checkbox" id="songdalchk" className="noLine"\n' +
        '                                           checked="checked" onClick="javascript:clickSongdalchk();"> 확인\n' +
        '                                </div>\n' +
        '                                <div className="conTextBul red">\n' +
        ...
        '                                    <td className="tit" style="color: #CC6600;">&nbsp;피고 김진식에게 이행권고결정등본/소송안내서(21.01.19)\n' +
        '                                        송달\n' +
        '                                    </td>\n' +
        ...
        '\n' +
        '                                    <td>&nbsp;<a\n' +
        '                                        onClick="javascript:goSongdalResult(\'부산지방법원 동부지원\',\'2020가소377585\',\'2021.01.20\', \'피고 김진식에게 이행권고결정등본/소송안내서(21.01.19) 송달\', \'2021.01.22 도달\', \'동거인(자녀)\')">\n' +
        ...
        '                                    <td className="tit" style="color: #CC6600;">&nbsp;원고 소송대리인 변호사 강청현에게\n' +
        '                                        답변서부본(21.01.29.자) 송달\n' +
        '                                    </td>\n' +
        '                                    <!-- 2007.03.23 [재판 SF 07-0031] -->\n' +
        '                                    <!-- 2012.05.14 [12LG-SF0013] [홈페이지 사건검색] 송달이 되었을때 송달자 확인이 가능하도록 개선 - 장진범 -->\n' +
        '\n' +
        '                                    <td>&nbsp;<a\n' +
        '                                        onClick="javascript:goSongdalResult(\'부산지방법원 동부지원\',\'2020가소377585\',\'2021.02.02\', \'원고 소송대리인 변호사 강청현에게 답변서부본(21.01.29.자) 송달\', \'2021.02.03 도달\', \'본인\')">\n' +
        ...
        '                                </div>\n' +
        '                                <div className="conTextBul">\n' +
        '                                    송달간주(발송송달)는 민사소송법 제189조에 의하여 서류를 당사자가 직접 송달 받지 않았다 하더라도 우체국 접수 시 송달된 것으로 간주되어 송달효력이\n' +
        '                                    발생하는 제도입니다.\n' +
        '                                </div>\n' +
        '                            </div>\n' +
        '\n' +
