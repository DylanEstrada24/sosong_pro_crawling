...
router.get('/v1/google/calendar/:token', (req, res)=>{

    let buffer = req.params.token;

    fs.readFile('./oauthFile/google/client_secret.json', (err, content ) => {
    ...
    return res.send(ApiResponse(false, "failed"));
